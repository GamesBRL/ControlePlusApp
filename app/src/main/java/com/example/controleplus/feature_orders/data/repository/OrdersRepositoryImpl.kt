package com.example.controleplus.feature_orders.data.repository

import com.example.controleplus.feature_orders.data.data_source.OrdersDao
...
class OrdersRepositoryImpl(
    ...
    override fun getOrdersByDate(date: LocalDateTime): Flow<List<Orders>> {
        return dao.getOrdersByDate(date)
    }

    override fun getIncomeOrdersByDate(date: LocalDateTime): Flow<List<Orders>> {
        return dao.getIncomeOrdersByDate(date)
    }

    override fun getExpenseOrdersByDate(date: LocalDateTime): Flow<List<Orders>> {
        return dao.getExpenseOrdersByDate(date)
    }
